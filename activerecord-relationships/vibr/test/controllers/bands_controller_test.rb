...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { genre: @band.genre, image: @band.image, name: @band.name } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { genre: @band.genre, image: @band.image, name: @band.name } }
